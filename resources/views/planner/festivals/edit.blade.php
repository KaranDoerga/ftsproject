<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Festival Bewerken: {{ $festival->name }}
        </h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('planner.festivals.update', $festival->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input id="start_date" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="date" name="start_date" value="{{ old('start_date', $festival->start_date) }}" required />
                                @error('start_date') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                            </div>

                            <div>
                                <label for="end_date" class="block font-medium text-sm text-gray-700 dark:text-gray-300">Einddatum</label>
                                <input id="end_date" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="date" name="end_date" value="{{ old('end_date', $festival->end_date) }}" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                            <div>
                                ...
                                <input id="postal_code" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="text" name="postal_code" value="{{ old('postal_code', $festival->postal_code) }}" required />
                                @error('postal_code') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                            </div>

                            <div>
                                <label for="city" class="block font-medium text-sm text-gray-700 dark:text-gray-300">Stad</label>
                                <input id="city" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="text" name="city" value="{{ old('city', $festival->city) }}" required />
                                @error('city') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                            </div>

                            <div>
                                <label for="country" class="block font-medium text-sm text-gray-700 dark:text-gray-300">Land</label>
                                <input id="country" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="text" name="country" value="{{ old('country', $festival->country) }}" required />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="line_up" name="line_up" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" rows="2">{{ old('line_up', $festival->line_up) }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <input id="music_genre" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="text" name="music_genre" value="{{ old('music_genre', $festival->music_genre) }}" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            ...
                            <div>
                                ...
                                <select id="status" name="status" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" required>
                                    <option value="concept" @if(old('status', $festival->status) == 'concept') selected @endif>Concept</option>
                                    <option value="published" @if(old('status', $festival->status) == 'published') selected @endif>Gepubliceerd</option>
                                    <option value="sold_out" @if(old('status', $festival->status) == 'sold_out') selected @endif>Uitverkocht</option>
                                </select>
